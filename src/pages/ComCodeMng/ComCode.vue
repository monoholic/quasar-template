      ...
      <q-card v-show="modalToggle" @mousedown="startDrag">
        <div class="form-container" v-show="formToggle">
          <q-card-actions>
            ...
            <q-input
              class="form-node"
              v-model="editedItem.uppCodeId"
              label="상위 공통코드 ID"
            />
            <q-space />
            <q-input
              class="form-node"
              v-model="editedItem.codeDesc"
              label="공통코드 설명"
            />

            <q-input
              class="form-node"
              v-model="editedItem.codeLvl"
              label="코드 레벨"
            />
            <q-space />
            <q-input
            ...
            <q-input
              class="form-node"
              v-model="editedItem.resv1"
              label="예비 1"
            />

            <q-input
              class="form-node"
              v-model="editedItem.resv2"
              label="예비 2"
            />
            <q-space />
            <q-input
              class="form-node"
              v-model="editedItem.resv3"
              label="예비 3"
            />
            <q-space />
            <q-select
...
export default {
  ...
  methods: {
    ...
    setTableData() {
      ...
      api
        .post("/comCode/getComCodeList", params)
        .then((res) => {
    ...
    saveData() {
      ...
      api
        .post("/comCode/codeAddMod", this.editedItem)
        .then((res) => {
          alert("저장완료");
          this.setTableData();
          this.closeModal();
