  ...
  <q-scroll-area class="fit">
    <q-list>
      ...
      <div v-for="menu in state.menuList" :key="menu.menuId">
        <q-expansion-item expand-separator :icon="menu.menuIcon" :label="menu.menuNm">
          ...
          <div v-for="subMenu in state.subMenuList" :key="subMenu.menuId">
            ...
            <q-expansion-item
              ...
              v-if="menu.menuId === subMenu.uppMenuId && subMenu.routeYn === 'Y'"
            >
              <div v-for="thirdMenu in state.thirdMenuList" :key="thirdMenu.menuId">
                <q-item 
                  :inset-level="2" 
            ...
            <q-item
              :inset-level="1"
              :label="subMenu.menuNm" 
              v-else-if="menu.menuId === subMenu.uppMenuId && subMenu.routeYn === 'N'" 
